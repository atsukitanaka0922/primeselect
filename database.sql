...
-- 商品画像データの挿入（受注生産商品）
INSERT INTO `product_images` (`product_id`, `image_file`, `is_main`, `created`) VALUES
...
-- テスト用予約注文データの挿入
INSERT INTO `preorders` (`id`, `user_id`, `product_id`, `variation_id`, `quantity`, `estimated_delivery`, `status`, `created`) VALUES
